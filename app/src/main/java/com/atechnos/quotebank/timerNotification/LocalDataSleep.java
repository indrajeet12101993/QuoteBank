...
public class LocalDataSleep {
    ...
    public LocalDataSleep(Context context)
    {
    ...
    public void setQuotes(String q) {
        prefsEditor.putString(quotes, q);
        prefsEditor.commit();
    ...
    public void setAuthor(String a) {
        prefsEditor.putString(author, a);
        prefsEditor.commit();
    }

    public String get_Author() {
        return appSharedPrefs.getString(author, null);
    }

    public String get_Quotes() {
        return appSharedPrefs.getString(quotes, null);
    }
